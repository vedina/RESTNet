...
public class RegistrationTest extends CRUDTest<IUser, UserRegistration> {
	...
	@Override
	protected IQueryUpdate<IUser, UserRegistration> createQuery() throws Exception {
	...
	@Override
	protected void createVerify(IQueryUpdate<IUser, UserRegistration> query) throws Exception {
		...
		table = c.createQueryTable("EXPECTED", String.format(
				"SELECT code from user_registration where user_name='mynewuser' and code='" + randomcode + "'"));
		Assert.assertEquals(1, table.getRowCount());
		c.close();
	...
	@Override
	protected IQueryUpdate<IUser, UserRegistration> createQueryNew() throws Exception {
		IDatabaseConnection c = getConnection();
		ITable table = c.createQueryTable("EXPECTED", String.format(
				"SELECT code from user_registration where user_name='admin' and code='ABCDEF' and status='confirmed'"));
	...
	@Override
	protected void createVerifyNew(IQueryUpdate<IUser, UserRegistration> query) throws Exception {
		IDatabaseConnection c = getConnection();
		ITable table = c.createQueryTable("EXPECTED", String.format(
				"SELECT code from user_registration where user_name='admin' and code='ABCDEF' and status='confirmed'"));
		Assert.assertEquals(1, table.getRowCount());
	...
	@Override
	protected IQueryUpdate<IUser, UserRegistration> updateQuery() throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	protected IQueryUpdate<IUser, UserRegistration> deleteQuery() throws Exception {
		IUser user = new TestUser();
	...
	@Override
	protected void updateVerify(IQueryUpdate<IUser, UserRegistration> query) throws Exception {
		IDatabaseConnection c = getConnection();
		ITable table = c.createQueryTable("EXPECTED",
	...
	@Override
	protected void deleteVerify(IQueryUpdate<IUser, UserRegistration> query) throws Exception {
