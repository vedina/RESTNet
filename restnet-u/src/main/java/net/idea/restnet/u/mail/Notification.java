...
public class Notification implements INotificationUtility {
	...
	try {
	    ...
	    /*
	     * A workaround to trust all certificates. Better to import the cert
    ...
    @Override
    public void sendNotification(String toEmail, String subject, Object content, String mimeType)
