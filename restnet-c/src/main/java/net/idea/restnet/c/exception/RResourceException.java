...
/**
 * Same as {@link ResourceException} , but with additional variant to go in the
 * message body, as specified in OpenTox error reports.
 * 
 * @author nina
 * 
 */
public class RResourceException extends ResourceException {
     ...
     */
    public RResourceException(final int code, final String name, final String description, final String uri,
	    Variant variant) {
     ...
     *            The wrapped cause error or exception.
     */
    public RResourceException(final Status status, final String description, final Throwable cause, Variant variant) {
