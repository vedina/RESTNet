...
public class CallablePolicyCreator extends CallableDBUpdateTask<IRESTPolicy<Integer>, Form, String> {
	...
	public CallablePolicyCreator(IRESTPolicy<Integer> policy,Method method, Form input,
	...
	protected Boolean getMethodAllowedValue(Object value) {
		...
		if ("on".equals(value.toString())) return true;
		if ("checked".equals(value.toString())) return true;
