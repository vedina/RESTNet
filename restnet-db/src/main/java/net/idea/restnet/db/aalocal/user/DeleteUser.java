...
public class DeleteUser extends AbstractObjectUpdate<IUser> implements IDBConfig {

	public static final String delete_sql = "delete from %s%susers where user_name=?";
