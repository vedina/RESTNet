 ...
 * @param <Output>
 */
public abstract class QueryRepresentationConvertor<T, Q extends IQueryRetrieval<T>, Output> extends
	...
	if (this.reporter != null)
	    ((QueryAbstractReporter<T, Q, Output>) this.reporter).setMaxRecords(5000);
    }
