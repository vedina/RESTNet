...
/**
 * Workaround for http://restlet.tigris.org/issues/show_bug.cgi?id=1245 , which is fixed in a later release.
 * equals and hash code copied from 
 * https://github.com/restlet/restlet-framework-java/blob/master/modules/org.restlet/src/org/restlet/security/Role.java
 * @author nina
 *
 */
public class DBRole<ALIAS> extends Role implements Serializable{
    ...
    public boolean equals(Object target) {
        ...
        if (target instanceof Role) {
            ...
            result = getName().equals(r.getName())
