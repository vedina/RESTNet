...
public abstract class AbstractStaxRDFWriter<INPUT, OUTPUT> extends DefaultAmbitProcessor<INPUT, OUTPUT> {
    ...
    public void setUriReporter(QueryURIReporter<INPUT, IQueryRetrieval<INPUT>> uriReporter) {
     ...
     * xml:base="http://apps.ideaconsult.net:8080/ambit2/"> <owl:Class
     * rdf:about="http://www.opentox.org/api/1.1#Dataset"/> <owl:Class
     * rdf:about="http://www.opentox.org/api/1.1#Compound"/> <owl:Class
     * rdf:about="http://www.opentox.org/api/1.1#Feature"/> <owl:Class
     * rdf:about="http://www.opentox.org/api/1.1#FeatureValue"/> <owl:Class
     * rdf:about="http://www.opentox.org/api/1.1#NumericFeature">
     * <rdfs:subClassOf rdf:resource="http://www.opentox.org/api/1.1#Feature"/>
     * </owl:Class> <owl:Class
     * rdf:about="http://www.opentox.org/api/1.1#DataEntry"/>
     * <owl:ObjectProperty
     ...
     * @throws Exception
     */
    public void writeObjectPropertyTriple(javax.xml.stream.XMLStreamWriter writer, OT.OTProperty otproperty)
	    throws Exception {
    ...
    public void writeDataPropertyTriple(javax.xml.stream.XMLStreamWriter writer, OT.DataProperty otproperty)
	    throws Exception {
