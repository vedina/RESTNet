 ...
 *
 */
public class Alert<USER extends User<String>> extends BeanResource<String>  {
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -4913190613032138438L;
	...
	public String toString() {
		...
		getUser()!=null && getUser().getResourceID()!=null?getUser().getResourceID():""
				);
	}
}
