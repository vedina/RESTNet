...
public class CookieAuthenticator extends ChallengeAuthenticator {
	private int sessionLength = 1000 * 60 * 45; // 45 min
	...
	@Deprecated 
    /** 
     * Use {@link org.restlet.ext.crypto.CookieAuthenticator}
     * 
     * @param context
     * @param optional
     * @param realm
	 ...
	 */
	public String formatCredentials(ChallengeResponse challenge, ClientInfo clientInfo)
			throws GeneralSecurityException {
		if (challenge == null)
			return null;
		// Data buffer
