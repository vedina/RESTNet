...
import net.idea.restnet.groups.user.db.AddGroupPerUser;
...
public class CallableGroupCreator extends CallableDBUpdateTask<IDBGroup, Form, String> {
    ...
    public CallableGroupCreator(Method method, IDBGroup item, GroupType type, DBUser user,
	    GroupQueryURIReporter<IQueryRetrieval<IDBGroup>> reporter, Form input, String baseReference,
    ...
    @Override
    protected IQueryUpdate<Object, IDBGroup> createUpdate(IDBGroup group) throws Exception {
    ...
    @Override
    protected Object executeQuery(IQueryUpdate<? extends Object, IDBGroup> q) throws Exception {
