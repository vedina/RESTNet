...
public class OTA {
	...
	DescriptorCalculation, PatternMining, PharmacophoreGeneration, PhysicoChemical, QuantumChemical, SimilarityDistance, Topological,
	// Learning
	MSDMTox, Clustering, Learning, Classification, EagerLearning, LazyLearning, Regression, MultipleTargets, SingleTarget,
	//
	SemiSupervised, Supervised, Unsupervised,
	//
	Rules,
	// Data processing
	Preprocessing, DataCleanup, Discretization, FeatureSelection, Normalization, Utility,
	// Misc
	Generation3D, SimilarityDistanceCalculation, Visualisation, ;
	public String getNS() {
