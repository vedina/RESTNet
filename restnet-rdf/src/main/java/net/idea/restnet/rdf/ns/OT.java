...
public class OT {
	...
	*/
    ...
    public static Model createModel(Model model,Reference uri, MediaType mediaType) throws ResourceException, IOException , MalformedURLException {
    ...
    public static void write(OntModel jenaModel, OutputStream output, MediaType mediaType, boolean isXml_abbreviation) throws IOException {
    	try {
