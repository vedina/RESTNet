package net.idea.restnet.rdf.sparql;
...
/**
 * Abstract class to iterate over OpenTox objects in RDF model. Constructors,
 * reading external sources (stream, representation, url) assume Jena -supported
 * RDF mime types. application/rdf+xml is the default.
 * 
 * @author nina
 * 
 * @param <Item>
...
public abstract class RDFSparqlIterator<Item> implements Iterator<Item> {
     ...
     */
    public RDFSparqlIterator(Representation representation, MediaType mediaType, String sparql)
	    throws ResourceException {
    ...
    /**
     * OpenTox object iterator - reads RDF representation , given a reference ad
     * mime type
     * 
     * @param reference
     * @param mediaType
    ...
    /**
     * Executes sparql query; Don't touch
     * 
     * @param sparqlQuery
     * @return
     * @throws ResourceException
