...
public class Annotea {
	...
	public Property createProperty(OntModel jenaModel) {
	    ...
	    return p != null ? p : jenaModel.createObjectProperty(String.format(_NS_BOOKMARK, toString()));
	}
    }
	...
	public Property createProperty(OntModel jenaModel) {
	    ...
	    return p != null ? p : jenaModel.createObjectProperty(String.format(_NS_ANNOTEA, toString()));
	}
    }
